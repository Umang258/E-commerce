...
export default function wishlist() {
  return (<>
    ...
    <MDBContainer className="py-3 h-300">
        ...
        <MDBCard className="card-registration card-registration-1" style={{ borderRadius: "15px", fontFamily: "DM Serif Display"}}>
          <MDBCol>
            <MDBTable responsive>
              <MDBTableHead>
                <tr>
              ...
              <MDBTableBody>
                <tr>
                  <th scope="row">
                    <div className="d-flex align-items-center">
                      <img
                        src={process.env.PUBLIC_URL + "/image/toys/t9.png"}
                        fluid
                        className="rounded-3"
                        style={{ width: "120px" }}
                        alt="Book"
                ...
                <tr>
                  <th scope="row">
                    <div className="d-flex align-items-center">
                      <img
                        src={process.env.PUBLIC_URL + "/image/toys/t2.png"}
                        fluid
                        className="rounded-3"
                        style={{ width: "120px" }}
                        alt="Book"
